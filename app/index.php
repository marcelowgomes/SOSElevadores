				...
				<div class="sidebar-section sidebar-user my-1">
					<div class="sidebar-section-body">
						<div class="media">
							...
							<div class="media-body">
								<div class="font-weight-semibold"><?php echo $user['user_nome'] ?></div>
				...
				<div class="sidebar-section">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-copy"></i> <span>Tarefas</span></a>

							<ul class="nav nav-group-sub" data-submenu-title="Layouts">
								<li class="nav-item"><a href="minhas_tarefas" class="nav-link active">Minhas Tarefas</a></li>
								<li class="nav-item"><a href="criar_tarefa" class="nav-link">Criar Tarefa</a></li>
...
<!-- Mirrored from demo.interface.club/limitless/demo/Template/layout_1/LTR/default/full/layout_fixed_header.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jul 2022 03:22:03 GMT -->
</html>
