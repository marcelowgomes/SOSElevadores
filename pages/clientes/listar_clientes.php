                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            ...
                            <tbody class="list form-check-all">
                                ...
                                ?>
                                    <tr>
                                        <th scope="row">
                                            <?php echo $linha['cliente_id'] ?>
                                        </th>

                                        <td class="customer_name"><?php echo $linha['cliente_fantasia'] ?></td>
                                        <td class="email"><?php echo $linha['cliente_telefone'] ?></td>
                                        <td class="phone"><?php echo $linha['cliente_cpf'] ?></td>
