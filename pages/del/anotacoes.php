...
@$conn->query("update anotacoes_clientes set anotacoes_lixeira = '2'
                                   
where anotacoes_clientes_id = '$_POST[id]' ");
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-body text-center p-5">
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <p class="text-muted mb-4"> Colaborador deletado com sucesso.</p>
