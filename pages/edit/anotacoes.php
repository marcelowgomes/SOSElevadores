...
@$conn->query("update anotacoes_clientes_id set anotacoes_clientes_id_cliente ='$_POST[cliente]',anotacoes_clientes_data = '$_POST[data]',anotacoes_clientes_observacoes = '$_POST[observacoes]'                               
