...
@$conn->query("update fluxo_caixa set fluxo_caixa_valor = '$_POST[valor]', fluxo_caixa_data = '$_POST[data]', fluxo_caixa_procedimento = '$_POST[procedimento]', fluxo_caixa_forma_pagamento = '$_POST[pagamento]', fluxo_caixa_cliente = '$_POST[cliente]', fluxo_caixa_colaboradores = '$_POST[colaboradores]' where fluxo_caixa_id  = '$_POST[id]' ");
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <div class="hstack gap-2 justify-content-center">
                                                                        ...
                                                                        <a href="listar_caixa" class="btn btn-success">Fechar</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
