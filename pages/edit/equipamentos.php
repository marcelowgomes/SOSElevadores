...
@$conn->query("update equipamentos set equipamento_id_cliente = '$_POST[cliente]',equipamento_nome = '$_POST[nome]',equipamento_modelo = '$_POST[modelo]',equipamentos_paradas = '$_POST[paradas]'
