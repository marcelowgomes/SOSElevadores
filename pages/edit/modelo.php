...
@$conn->query("update modelos set modelo_nome = '$_POST[nome]', modelo_marca = '$_POST[modelo]', modelo_oleo = '$_POST[oleo]', modelo_bateria = '$_POST[bateria]'
                                   
where modelo_id = '$_POST[id]' ");
