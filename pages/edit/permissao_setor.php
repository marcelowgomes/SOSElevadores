...
@$conn->query("DELETE from user_setores where id_user_setor  = '$id' ");

}

if($id2 =='l') { 
$conn->query($insert = "INSERT INTO user_setores (user_setor_setor, id_user_usuario, id_user_quem, id_user_data) VALUES ('$id3','$id','$iduser','$data1')");
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-body text-center p-5">
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <p class="text-muted mb-4"> Permissão atualizada com sucesso.</p>
