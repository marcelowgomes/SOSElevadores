...
@$conn->query("update setores_tarefas set setor_tarefa_nome ='$_POST[nome]' where setor_terefa_id  = '$_POST[id]' ");
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-body text-center p-5">
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <p class="text-muted mb-4"> Setor atualizado com sucesso.</p>
                                                                    <div class="hstack gap-2 justify-content-center">
                                                                        
                                                                        <a href="formulario_setor" class="btn btn-success">Fechar</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
