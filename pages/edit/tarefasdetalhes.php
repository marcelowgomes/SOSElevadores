...
@$conn->query("update tarefas set tarefa_titulo = '$_POST[titulo]', tarefa_observacoes = '$_POST[observacoes]'  where tarefa_id = '$_POST[tarefa]' ");
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <div class="hstack gap-2 justify-content-center">
                                                                        ...
                                                                        <a href="minhas_tarefas" class="btn btn-success">Fechar</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
