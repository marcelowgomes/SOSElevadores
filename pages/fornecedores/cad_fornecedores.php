                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <form id="formcad1" action="#" method="post" >
                                                <div class="col-md-12">
                                                    <label for="validationCustom01" class="form-label">CNPJ/CPF:</label>
                                                    <input type="text" name="login" class="form-control" id="login" required onkeydown="javascript: fMasc( this, mCPF );">
...
$(document).ready(function () {
    ...
    $('#login').blur(function() {
        $th = $(this);
          $.ajax({
            url: 'pages/consultas/fornecedores.php',
            type: 'POST',
            data: {login: $th.val()},
            beforeSend: function(){
...
/// EXIBIR FORMULARIO DE CADASTRO
 ...
 $(document).ready(function() {
	 ...
	 $("#formcad1").submit(function(){
		...
		$.ajax({
			url: 'pages/fornecedores/formulario.php',
			cache: false,
			data: dados,
			type: "POST",  
