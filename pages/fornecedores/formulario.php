...
<form method="post" action="inserirfornecedores" id="formcadastro2a"> 
											 ...
											 <div class="row gy-3">
												 ...
												 <div class="col-lg-6">
                                                   <div>
                                                     <label class="form-label mb-0">CNPJ/CPF:</label>
                                                       <input name="cpf" type="text" class="form-control" id="cpf2" value="<?php echo $_POST['login'] ?>" readonly="readonly"  >
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div>
                                                        ...
                                                        <input name="ie"  type="text" class="form-control" id="ie" >
                                                    </div>
                                                </div>
												 ...
												 <div class="col-lg-6">
                                                   <div>
                                                     <label class="form-label mb-0">Pais:</label>
                                                       <input name="pais" type="text" class="form-control"  value="Brasil" readonly="readonly" >
                                                    </div>
                                                </div>
