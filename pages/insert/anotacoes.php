...
$conn->query($insert = "INSERT INTO anotacoes_clientes (anotacoes_clientes_id_cliente,anotacoes_clientes_data,anotacoes_clientes_observacoes)
                                VALUES ('$_POST[clientes]','$_POST[nome]','$_POST[observacoes]')");
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <div class="hstack gap-2 justify-content-center">
                                                                        ...
                                                                        <a href="formulario_anotacoes" class="btn btn-success">Fechar</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
