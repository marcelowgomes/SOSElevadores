...
$conn->query($insert = "INSERT INTO equipamentos (equipamento_id_cliente,equipamento_nome,equipamento_modelo,equipamentos_paradas,equipamentos_porta,equipamento_id_marca)
                                VALUES ('$_POST[clientes]','$_POST[nome]','$_POST[modelo]','$_POST[paradas]','$_POST[porta]','$_POST[marca]')");
                                                            ...
                                                            <div class="modal-body text-center p-5">
                                                                ...
                                                                <div class="mt-4">
                                                                    ...
                                                                    <div class="hstack gap-2 justify-content-center">
                                                                        ...
                                                                        <a href="listar_equipamento_cliente" class="btn btn-success">Fechar</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
