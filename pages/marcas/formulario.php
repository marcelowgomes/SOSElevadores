...
<!-- INICIO DADOS INICIAIS -->
 ...
 <div class="row">
								 ...
								 <!-- INICIO DADOS contrato -->
                                  ...
                                  <form method="post" action="inserir_marcas" id="formcadastro2a"> 
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">  <h4>Marca</h4> </div>

                        

                         <div class="col-md-12"> <label class="form-label mb-0">Informe o nome da marca:</label>

                                                     <input name="nomee" type="text" class="form-control" id="nome"  >
                        ...
                        <div class="col-md-6">
                            ...
                            <h4>Modelo</h4> <h6>Para adicionar mais de um modelo clique em ADICIONAR </h6>

                        </div>

                        <div class="col-md-6 d-flex flex-row-reverse">

                            <span class="btn btn-danger " id="deleteRow" style="height: 30px">Deletar</span>

                            <span class="btn btn-success mx-3" id="addRow" style="height: 30px">Adicionar</span>
                                ...
                                <div class="add">
                                    ...
                                    <div class="row my-4">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <label class="form-label mb-0">informe o nome do modelo:</label>
