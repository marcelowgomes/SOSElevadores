                        ...
                        <div class="col-sm">
                            <div class="d-flex justify-content-sm-end">
                                <div class="search-box ms-2">
                                    <input type="text" class="form-control search" placeholder="Localizar marca">
...
<th class="sort" data-sort="customer_name">Ações</th>
                            ...
                            <tbody class="list form-check-all">
                                ...
                                <?php
                                $sql = "SELECT * FROM marcas ORDER BY marca_id";
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="status">
                                            ...
                                            <a href="formulario_modelo2/<?php echo $linha['marca_id'] ?>" class="link-secundary fs-15"><i class=" ri-file-list-2-line"></i></a>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body text-center p-5">
                                                    ...
                                                    <div class="mt-4 pt-4">
                                                        <h4>Atenção!!</h4>
                                                        <p class="text-muted"> Deseja mesmo deletar esta marca?</p>
                                                ...
                                                <div class="modal-body text-center p-5">
                                                    ...
                                                    <div class="mt-4 pt-3">
                                                        ...
                                                        <div class="hstack gap-2 justify-content-center">
                                                            ...
                                                            <form action="deletar_marcas" method="post" id="sa-departamento">
