...
$targetPath = dirname( __FILE__ ) . "/fotos/$_GET[id]/";
        ...
        if ( is_writable($targetPath) ) {
            ...
            if ( !file_exists($targetFile) ) {
                ...
                if ( file_exists($targetFile) ) {
                    ...
                    $response = array (
                        'status' => 'error',
                        'info'   => 'Não foi possível enviar o arquivo solicitado :(, ocorreu um erro misterioso.'
                    );
                }
                ...
                $response = array (
                    'status'    => 'error',
                    'info'      => 'Existe um arquivo com o mesmo nome.',
                    'file_link' => $targetFile
                );
            }
