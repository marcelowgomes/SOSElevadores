                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Minhas Tarefas - Geral</h4>
...
$sql = "SELECT * FROM status_tarefas WHERE  status_tarefas_padrao ='1' and status_tarefas_setor ='0' order by status_tarefas_posicao asc  ";
...
//$date = date('Y-m-d H:i');	
 ...
 <?php echo $linha['status_tarefas_titulo']  ?>  </strong> <br><br> </div>
			  ...
			  <?php
$sqlt = "SELECT * FROM tarefas WHERE tarefa_status <>'2' and tarefa_lixeira ='1' and tarefa_para = '$iduser' and tarefa_status = $linha[id_status_tarefas]  ORDER BY tarefa_prazo asc ";	
...
<?php } ?>			  
	...
	<!-- Modal flip edit --><form action="atualizar_tarefa_detalhes" method="post"> 
			
                                                <div id="flipModal2<?php echo $linhat['tarefa_id'] ?>" class="modal  fade flip" tabindex="-1" aria-labelledby="flipModalLabel" aria-hidden="true" style="display: none;">
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header ">
															 ...
															 <div class="modal-header"> 
																  ...
																  <input type="text" required name="titulo" class="form-control" value="<?php echo $linhat['tarefa_titulo'] ?>">   
                                                                </span>
                                                            ...
                                                            <div class="modal-body">
                                                                <span class="text-opacity-75" style="font-size: 15px;">
																	...
																	<span class="text-opacity-75" style="font-size: 15px;">
																	  <i class="  bx bx-copy-alt"> </i>  Titulo 
                                                                </span>
																...
																<span class="text-opacity-75" style="font-size: 15px;">
																	 <i class=" bx bx-message-rounded-error"> </i>  Observações 
                                                                </span>
																	<textarea class="form-control" name="observacoes" ><?php echo $linhat['tarefa_observacoes'] ?></textarea>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <span class="text-opacity-75" style="font-size: 15px;">
																	 ...
																	 <i class="  bx bx-copy-alt"> </i>  <?php echo $linhat['tarefa_titulo'] ?> <a href="#" data-bs-toggle="modal" data-bs-target="#flipModal2<?php echo $linhat['tarefa_id'] ?>"> <i class="bx bxs-edit"> </i></a>
																...
																<span class="text-opacity-75" style="font-size: 15px;">
                                                                  <i class=" bx bx-message-rounded-error"> </i>  Observações <a href="#" data-bs-toggle="modal" data-bs-target="#flipModal2<?php echo $linhat['tarefa_id'] ?>"> <i class="bx bxs-edit"> </i></a>
                                                                </span>
...
while ($linhaat=mysqli_fetch_array($resultadoat)) {
		 ...
		 <div class="col-6">
            <label>Tarefa para:</label>
			 <select class="form-control" name="user" required>
						
						<?php
	
$sqlt1 = "SELECT * FROM users  WHERE user_id   = '$linhat[tarefa_para]' ";
$resultadot1 = mysqli_query($conn, $sqlt1);
$linhat1=mysqli_fetch_array($resultadot1);
	?>
						
					  <option value="<?php echo $linhat1['user_id'] ?>"><?php echo $linhat1['user_nome'] ?></option>
...
$sqlat = "SELECT * FROM users  WHERE user_status = 1 and user_lixeira = 1 and user_id <> $linhat1[user_id]    ORDER BY user_nome ";
$resultadoat = mysqli_query($conn, $sqlat);
while ($linhaat=mysqli_fetch_array($resultadoat)) {
				?>		
					  <option value="<?php echo $linhaat['user_id'] ?>"><?php echo $linhaat['user_nome'] ?></option>
						<?php } ?>
